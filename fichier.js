    ...
    var canvas1 = document.getElementById('canvasL');
    var contexte = canvas1.getContext('2d');
                
                contexte.lineWidth = '5';
                contexte.strokeStyle = '#2BB';
                contexte.arc(34, 33, 32, Math.PI/2, -Math.PI/2);
                contexte.stroke();
                
                contexte.fillStyle = '#FFF';
                contexte.font = 'bold 20px Arial, Verdana, Serif';
                contexte.lineWidth = '4';
                contexte.fillText('Sénégalaise',23,23);
                contexte.fillText('Des',23,41);
                contexte.fillText('Jeux',23, 59);
                
                contexte.beginPath();
                contexte.fillStyle = '#FFF';
                contexte.moveTo(94, 59);
                contexte.lineTo(109, 29);
                contexte.lineTo(124, 59);
                contexte.lineTo(89, 44);
                contexte.lineTo(129, 44);
                contexte.lineTo(94, 59);
                contexte.fill();
                
                contexte.beginPath();
                contexte.lineWidth = '5';
                contexte.strokeStyle = '#2BB';
                contexte.arc(129, 33, 32, -Math.PI/2, Math.PI/2);
                contexte.stroke();
        ...
        function horloge() {
            ...
            heure.innerHTML =jours[jour]+' '+date+' '+mois[moi]+' | '+ d.toLocaleTimeString();
        }
//
// Voir à la fin pour déclaration du slider
//
...
/*** Fin de la librairie Sliderman ***/

var toTop = {name: "toTop", bottom: true, move: true, duration: 400};

var slider_test = Sliderman.slider({
    container: "slider_test",
    width: 535,
    height: 300,
    effects: [toTop],
    display: {
        autoplay: 3000
                ...
                function affiche() {
                    contexteO.drawImage(image, 50, 25, 400, 174);
                    }
